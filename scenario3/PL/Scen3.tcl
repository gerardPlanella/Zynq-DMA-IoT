...
#
# Scen3.tcl: Tcl script for re-creating project 'Env_3'
#
# Generated by Vivado on Wed May 13 10:16:12 CEST 2020
...
#
# 1. This project restoration tcl script (Scen3.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/gerard/Documents/TFG/ZynqDmaAnalysis/HW/Env_3/Env_3.srcs/sources_1/bd/env_1/hdl/env_1_wrapper.vhd"
#    "/home/gerard/Documents/TFG/ZynqDmaAnalysis/HW/Env_3/Env_3.srcs/sources_1/new/tg_control.vhd"
#    "/home/gerard/Documents/TFG/ZynqDmaAnalysis/HW/Env_3/Env_3.srcs/constrs_1/new/cora_z7_07s.xdc"
#    "/home/gerard/Documents/TFG/ZynqDmaAnalysis/HW/Env_3/Env_3.srcs/sim_1/new/tb_tg_control_2.vhd"
#    "/home/gerard/Documents/TFG/ZynqDmaAnalysis/HW/Env_3/cfg_tb_tg_control_behav.wcfg"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../../ZynqDmaAnalysis/HW/Env_3"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../ZynqDmaAnalysis/Tests/axis_counter"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/../../../ZynqDmaAnalysis/HW/Env_3/Env_3.srcs/sources_1/bd/env_1/hdl/env_1_wrapper.vhd" ]\
 [file normalize "${origin_dir}/../../../ZynqDmaAnalysis/HW/Env_3/Env_3.srcs/sources_1/new/tg_control.vhd" ]\
]
...
set file "hdl/env_1_wrapper.vhd"
...
set_property -name "top" -value "env_1_wrapper" -objects $obj
...
set file "[file normalize ${origin_dir}/../../../ZynqDmaAnalysis/HW/Env_3/Env_3.srcs/constrs_1/new/cora_z7_07s.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/cora_z7_07s.xdc"
...
set_property -name "target_constrs_file" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/new/cora_z7_07s.xdc" -objects $obj
set_property -name "target_ucf" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/new/cora_z7_07s.xdc" -objects $obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../../../ZynqDmaAnalysis/HW/Env_3/Env_3.srcs/sim_1/new/tb_tg_control_2.vhd" ]\
 [file normalize "${origin_dir}/../../../ZynqDmaAnalysis/HW/Env_3/cfg_tb_tg_control_behav.wcfg" ]\
]
...
set file "new/tb_tg_control_2.vhd"
...
set file "Env_3/cfg_tb_tg_control_behav.wcfg"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set_property -name "top" -value "cfg_tb_tg_control" -objects $obj
...
# Proc to create BD env_1
proc cr_bd_env_1 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name env_1
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {234.295} \
   CONFIG.CLKOUT1_PHASE_ERROR {359.620} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {146} \
   CONFIG.CLKOUT2_DRIVES {BUFG} \
   CONFIG.CLKOUT2_JITTER {261.550} \
   CONFIG.CLKOUT2_PHASE_ERROR {359.620} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {58.250} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_4_GPIO [get_bd_intf_ports rgb_leds] [get_bd_intf_pins axi_gpio_3/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_traffic_gen_0_M_AXIS_MASTER [get_bd_intf_pins axi_traffic_gen_0/M_AXIS_MASTER] [get_bd_intf_pins fifo_generator_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_4/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_4/Din] [get_bd_pins xlslice_5/Din]
  connect_bd_net -net axi_gpio_4_ip2intc_irpt [get_bd_pins axi_gpio_4/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins c_counter_binary_0/Q]
  connect_bd_net -net c_counter_binary_1_Q [get_bd_pins axi_gpio_1/gpio2_io_i] [get_bd_pins c_counter_binary_1/Q]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_traffic_gen_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK]
  connect_bd_net -net fifo_generator_0_axis_overflow [get_bd_pins fifo_generator_0/axis_overflow] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net fifo_generator_0_axis_prog_empty [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins fifo_generator_0/axis_prog_empty] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net fifo_generator_0_axis_rd_data_count [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins fifo_generator_0/axis_rd_data_count]
  connect_bd_net -net fifo_generator_0_axis_wr_data_count [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins fifo_generator_0/axis_wr_data_count]
  connect_bd_net -net fifo_generator_0_rd_rst_busy [get_bd_pins fifo_generator_0/rd_rst_busy] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net fifo_generator_0_wr_rst_busy [get_bd_pins fifo_generator_0/wr_rst_busy] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins fifo_generator_0/s_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axi_traffic_gen_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins fifo_generator_0/m_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axi_gpio_2/gpio2_io_i] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_traffic_gen_0/m_axis_1_tready] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins c_counter_binary_0/CE] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins c_counter_binary_0/SCLR] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins c_counter_binary_1/CE] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins c_counter_binary_1/SCLR] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins proc_sys_reset_1/aux_reset_in] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins proc_sys_reset_2/aux_reset_in] [get_bd_pins xlslice_5/Dout]
  ...
  assign_bd_address -offset 0x40400000 -range 0x00008000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_4/S_AXI/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_traffic_gen_0/S_AXI/Reg0] -force
...
# End of cr_bd_env_1()
cr_bd_env_1 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files env_1.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files env_1.bd ] 
set_property IS_ENABLED "1" [get_files env_1.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files env_1.bd ] 
set_property IS_LOCKED "0" [get_files env_1.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files env_1.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files env_1.bd ] 
set_property PFM_NAME "" [get_files env_1.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files env_1.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files env_1.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files env_1.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files env_1.bd ] 
set_property USED_IN_SIMULATION "1" [get_files env_1.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files env_1.bd ] 
